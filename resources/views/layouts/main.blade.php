        ...
        <div class="container-fluid d-flex align-items-center px-4">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                ...
                <ul class="offset-md-1 navbar-nav mr-auto">
                    <li class="nav-item active"><a href="{{ env('APP_URL') }}/"
                            class="nav-link pl-0">{{ __('messages.Home') }}</a></li>
                    <li class="nav-item"><a href="{{ env('APP_URL') }}#about"
                            class="nav-link about">{{ __('messages.About') }}</a></li>
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle">{{ __('messages.Courses') }}</a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item"
                                    href="{{ env('APP_URL') }}/Languages">{{ __('messages.dropE') }}</a></li>
                            <li><a class="dropdown-item" href="{{ env('APP_URL') }}/IT">{{ __('messages.dropD') }}</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="{{ env('APP_URL') }}/Accounting">{{ __('messages.dropC') }}</a></li>
                            <li><a class="dropdown-item"
                                    href="{{ env('APP_URL') }}/Curriculums">{{ __('messages.dropB') }}</a></li>
          ...
          <button type="submit" placeholder="" class="form-control search"><span class="ion-ios-search"></span></button>
                ...
                <div class="dropdown" style="margin: 9px;margin-bottom:0px; ">
                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="height: 31px;">
                    ...
                    <li>
                        ...
                        <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-3 ">
                            ...
                            <li class="ftco-animate "><a
                                    href="https://www.facebook.com/CCITclassmates?mibextid=ZbWKwL"><span
                                        class="icon-facebook"></span></a></li>
                            <li class="ftco-animate"><a
                                    href="https://www.instagram.com/ccitclassmates?igsh=YW5zMXd6czQ5Nnc4"><span
                                        class="icon-instagram"></span></a></li>
                            <li class="ftco-animate"><a href="https://t.me/ccitclassmates"><span
                                        class="icon-telegram"></span></a></li>
                            <li class="ftco-animate"><a href="https://www.youtube.com/@ccitclassmates6116"><span
            ...
            <div class="row mb-5">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li><span class="icon icon-map-marker"></span><span
                                        class="text">{{ __('messages.location') }}</span></li>
                                <li><a href="#"><span class="icon icon-phone"></span><span
                                            class="text phone">+963 955 229 971</span></a></li>
                                <li><a href="#"><span class="icon icon-envelope"></span><span
                                            class="text">info@change-cit.com</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="ftco-footer-widget mb-5 ml-md-4">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="{{ env('APP_URL') }}/"><span
                                        class="ion-ios-arrow-round-forward mr-2"></span>{{ __('messages.Home') }}</a>
                            </li>
                            <li><a href="{{ env('APP_URL') }}/#about"><span
                                        class="ion-ios-arrow-round-forward mr-2 about"></span>{{ __('messages.About') }}</a>
                            </li>
                            <li><a href="{{ env('APP_URL') }}/#courses"><span
                                        class="ion-ios-arrow-round-forward mr-2"></span>{{ __('messages.Courses') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 ">
                    <div class="ftco-footer-widget mb-5">
                        ...
                        <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-3">
                            <li class="ftco-animate"><a href="https://www.facebook.com/CCITclassmates"><span
                                        class="icon-facebook"></span></a></li>
                            <li class="ftco-animate"><a href="https://www.instagram.com/ccitclassmates"><span
                                        class="icon-instagram"></span></a></li>
                            <li class="ftco-animate"><a href="https://t.me/ccitclassmates"><span
                                        class="icon-telegram"></span></a></li>
                            <li class="ftco-animate"><a href="https://www.youtube.com/@ccitclassmates6116"><span
